...
from app.services.slide_build_artifacts import read_slide_manifest
    ...
    for r, row in enumerate(body_rows, start=1):
        for c in range(cols):
            ...
            if "✅" in val or "✔" in val:
                ...
                p.font.bold = True
            elif "✕" in val or "✖" in val or "×" in val or val.strip().lower().startswith("no "):
